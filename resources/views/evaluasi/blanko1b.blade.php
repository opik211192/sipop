...
<body>
    ...
    <script>
        ...
        function calculateWeights() {
            ...
            let weight = (itemsPresent / totalItems) * 100;
            $('#bobot-ada-tidak-ada').val(weight.toFixed(2));
            $('#hasil-ada-tidak-ada').val(weight.toFixed(2));
            ...
            $('#evaluasi-awal-form').on('submit', function (event) {
                ...
                $.ajax({
                    ...
                    error: function (xhr, status, error) {
                        alert('Terjadi kesalahan. Silakan coba lagi.');
                        console.log(xhr.responseText); // Tambahkan ini untuk melihat pesan kesalahan di konsol
                    }
                });
            });
        });
