...
<body>
    <div class="container-fluid">
        ...
        <div id="uploadSection" class="mb-2">
            <?php
            $tahapanBlanko1c = $jaringan->tahapans->where('nama_tahapan', 'Evaluasi Awal Kesiapan')->first();
            $dokumenBlanko1c = $tahapanBlanko1c ? $tahapanBlanko1c->dokumens->where('nama_dokumen', 'Blanko 1C')->first() : null;
            ?>
            @if ($dokumenBlanko1c)
            <!-- Tombol Show Dokumen -->
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="showDokumenLabel">Lihat Dokumen Blanko 1C</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <iframe src="{{ asset('storage/blanko1c/' . basename($dokumenBlanko1c->path_dokumen)) }}"
            ...
            <script>
                ...
                $('#deleteDokumenBtn').on('click', function () {
                    if (confirm('Apakah Anda yakin ingin menghapus dokumen ini?')) {
                        $.ajax({
                            url: '{{ route("delete-blanko1c", $jaringan->id) }}',
                            type: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}'
                            },
            ...
            <div class="col-md-6">
                <form id="upload-blanko1c-form" action="{{ route('upload-blanko1c', $jaringan->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        <label for="blanko1c" class="form-label">Upload Blanko 1C</label>
                        <div class="input-group">
                            <input type="file" class="form-control" id="blanko1c" name="blanko1c">
    ...
    <script>
        ...
        $('#upload-blanko1c-form').on('submit', function(e) {
            e.preventDefault();
                            ...
                            <div class="modal fade" id="showDokumenModal" tabindex="-1" role="dialog" aria-labelledby="showDokumenLabel"
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <iframe src="/storage/blanko1c/${response.fileName}" width="100%" height="400px"></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
